<x-layout>
    <x-card class="!p-10 max-w-lg mx-auto mt-24">
        <header class="text-center">
            ...
            <p class="mb-4">Edycja ogłoszenia: {{$listing->title}}</p>
        </header>
        ...
        <form method="POST" action="/listings/{{$listing->id}}" 
            ...
            @method('PUT')
            <div class="mb-6">
                <label for="company" class="inline-block text-lg mb-2">Nazwa pracodawcy</label>
            ...
            <div class="mb-6">
                <label for="title" class="inline-block text-lg mb-2">Tytuł ogłoszenia</label>
            ...
            <div class="mb-6">
                <button class="bg-php text-white rounded py-2 px-4 hover:bg-php-dark">
